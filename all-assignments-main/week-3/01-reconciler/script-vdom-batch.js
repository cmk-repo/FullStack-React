// this will maintin a in memory of what is actuall in DOM
// finds diff with local copy and then updates it to the local dom the update is needed
// then it gets pushed to the main DOM
// so 1 copy of DOM always exist in the main screen
// in this we do batch updates 
...
}, 1000); // update every 2 milli seconds 

window.setInterval(() => {
  createDomElements();
}, 2000); // push the group update to main dom even 1 second
