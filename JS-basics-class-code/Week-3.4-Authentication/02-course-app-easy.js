...
app.post('/admin/courses', adminAuthentication, (req, res) => {
  ...
  if (!course.title) {
    return res.json(411).send({ "msg": "Please send the title" })
  }
...
app.post('/users/courses/:courseId', userAuthentication, (req, res) => {
  ...
  if (course) {
    ...
    // find the users in the global user array 
    // updare the user object 
    // remove the old user object to the USER global array
    // add the new uesr object to the USER global array
